Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/sncf-connect-tech/VSTableViewDescriptor"
  s.license          = 'MIT'
  s.author           = { "GWENN GUIHAL" => "gwenn.guihal@gmail.com" }
  s.source           = { :git => "https://github.com/sncf-connect-tech/VSTableViewDescriptor.git", :tag => "1.0.5" }
